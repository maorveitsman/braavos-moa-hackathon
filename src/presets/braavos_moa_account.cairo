...
mod BraavosMoaAccount {
    ...
    impl IMoaAccountImpl of IBraavosMOA<ContractState> {
        ...
        fn __execute__(ref self: ContractState, calls: Span<Call>) -> Array<Span<felt252>> {
            ...
            let pending_tx_hash = calculate_moa_tx_hash(proposer_guid, nonce, actual_calls);
        ...
        fn __validate_declare__(self: @ContractState, class_hash: felt252) -> felt252 {
            assert(class_hash.is_non_zero(), Errors::INVALID_TX);
                        ...
                        if validate_preamble {
                            ...
                            assert(
                                signer
                                    .signer
                                    .validate_signature(
                                        hash, *signer.preamble_r, *signer.preamble_s
                                    ),
